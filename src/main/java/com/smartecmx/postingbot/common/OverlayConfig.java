...
public enum OverlayConfig {
    ...
    TECHNICALTIP_1_XAYEGE("Arial", 58, "bold", "#000000", "north_west", 70, 220, 900, "right"),
    TECHNICALTIP_1_XAYEGE_CTA("Courier", 41, "bold", "#FFFFFF", "north_west", 280, 1270, 800, "center"),
    TECHNICALTIP_2_UUBFSU("Arial", 48, "bold", "#000000", "north_west", 100, 400, 750, "left"),
    ...
    TECHNICALTIP_4_TCZA85("Arial", 56, "bold", "#000000", "north_west", 100, 300, 900, "center"),
    TECHNICALTIP_4_TCZA85_CTA("Courier", 43, "bold", "#FFFFFF", "north_west", 280, 1268, 800, "center"),
    TECHNICALTIP_5_AQE4OQ("Arial", 58, "bold", "#FFFFFF", "north_west", 100, 350, 430, "left"),
